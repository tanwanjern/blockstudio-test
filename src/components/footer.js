                ...
                <div className="row">
                    ...
                    <div className="w-full lg:w-1/2">
                        <ul className="row mb-6">
                            <li className="flex-1 text-center lg:text-left"><a href="" className="text-white">About</a></li>
                            <li className="flex-1 text-center lg:text-left"><a href="" className="text-white">Website</a></li>
                    ...
                    <div className="flex-1">
                        <ul className="flex flex-row flex-wrap items-center lg:justify-end justify-center">
