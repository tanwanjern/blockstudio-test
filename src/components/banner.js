...
const Banner = () => {
                            ...
                            return(
                                <SwiperSlide key={"swiper_"+index}>
                                    <div className="relative w-full h-full bg-gray-100">
                                        {index == 0 ? 
                                            <div className="lg:bg-fixed bg-no-repeat bg-cover bg-center w-full h-full" style={{backgroundImage: `url('https://images.unsplash.com/photo-1485627941502-d2e6429a8af0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80')`}}></div>
                                            :
                                        ...
                                        <div className="absolute z-20 top-0 bottom-0 left-0 right-0">
                                            <div className="h-full center">
                                                <h1 data-aos="fade-up" data-aos-duration="450" data-aos-delay="100" className="w-4/5 xl:w-3/5 mx-auto text-3xl lg:text-5xl font-bold text-center leading-tight mb-3">Commercial builders with pride-workmanship that values quality</h1>
                                                <p data-aos="fade-up" data-aos-duration="450" data-aos-delay="200" className="w-3/4 xl:w-2/4 mx-auto text-center leading-relaxed">Acclaim Contractors are a highly specialised local business with over 20 years building and civil industry experience with many accolades, commendations and awards recognising the building</p>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
    ...
    const Copyright = () => {
        return(
            <div className="absolute top-0 bottom-0 h-full z-10 w-10 hidden lg:block" data-aos="fade-down" data-aos-duration="450" data-aos-delay="200">
        ...
        return(
            <div className="absolute bottom-0 left-0 z-40 lg:w-56 hidden lg:flex p-10">
                <ul className="flex flex-row flex-wrap items-center mt-10 justify-between w-full">
                    <li data-aos="fade-right" data-aos-duration="450" data-aos-delay="300" data-aos-offset="-500">
                        <a href="">
                    ...
                    <li data-aos="fade-right" data-aos-duration="450" data-aos-delay="400" data-aos-offset="-500">
                        <a href="">
                    ...
                    <li data-aos="fade-right" data-aos-duration="450" data-aos-delay="500" data-aos-offset="-500">
                        <a href="">
    ...
    return(
       <>
            <div className="h-screen relative z-20">
                ...
                <div className="home-custom-shape" data-aos="fade-up" data-aos-duration="450" data-aos-delay="500" data-aos-offset="-300">
                    <div className="inner">
