                            ...
                            >
                                {
                                    item.node.type === 1 ? (
                                        <div className="p-4 lg:p-8">
                                            <h3 className="font-semibold text-lg lg:text-4xl mb-5 lg:mb-36 leading-tight">{item.node.title}</h3>
                                        ...
                                        <div className="flex lg:flex-col flex-row">
                                            ...
                                            <div className="p-4 lg:p-6">
                                                ...
                                                <h3 className="font-semibold text-lg lg:text-2xl mb-5">{item.node.title}</h3>
